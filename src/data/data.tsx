...
import { BsBootstrapFill, BsPersonLinesFill, BsGithub, BsGoogle } from 'react-icons/bs';
import { RiContactsLine, RiReactjsLine } from 'react-icons/ri';
import { SiFuturelearn, SiSass, SiJquery, SiExpress, SiRedux } from 'react-icons/si';
...
const sideBarMenu = [
  ...
  {
    text: 'Blog',
    icon: <ImBlogger className='link-icon' style={{ fill: 'current', stroke: 'current' }} />,
    url: '/blog',
  },
  {
    text: 'Contacts',
