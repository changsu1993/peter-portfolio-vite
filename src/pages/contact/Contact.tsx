...
const Contact = React.memo(() => {
  ...
  const showMessage = (message?: any, updateColor?: any) => {
  ...
  const onSubmit = (e: any) => {
    ...
    if (!email && !message) {
      ...
      emailjs.sendForm('service_nkltoao', 'template_bcrcm2l', form.current, '9cr9U8nTbU4V-9v7_');
      setSuccess(emailRef);
        ...
        <form ref={form} className='contact-form' onSubmit={onSubmit}>
          <div>
            ...
            <Fade direction='down' triggerOnce>
              <p>
                I’m interested in freelance opportunities and I am always ready to build projects at anytime, if you have any job offer for me, you
          ...
          <Fade direction='down' triggerOnce>
            <div className='input-wrapper'>
              <div className='form-input-group'>
                <input autoComplete='false' type='text' placeholder='Name' name='name' value={validInpt.name} onChange={handleChange} />
          ...
          <Fade direction='down' triggerOnce>
            <div className='form-input-group'>
              <input autoComplete='false' type='text' placeholder='Subject' name='subject' value={validInpt.subject} onChange={handleChange} />
              <span className='switch__bg'></span>
              <BsExclamationLg className='exclamation' />
              <BsPatchCheckFill className='checkCircle' />
            </div>
